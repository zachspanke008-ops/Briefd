    ...
    <>
      ...
      <div className="min-h-screen bg-black flex flex-col relative overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0" aria-hidden>
          ...
          <svg style={{ position:"absolute", top:"50%", left:"50%", width:2000, height:2000, animation:"spin-cw 70s linear infinite" }} viewBox="0 0 1000 1000" fill="none" overflow="visible">
          ...
          <svg style={{ position:"absolute", top:"50%", left:"50%", width:1500, height:1500, animation:"spin-ccw 50s linear infinite" }} viewBox="0 0 700 700" fill="none" overflow="visible">
          ...
          <svg style={{ position:"absolute", top:"50%", left:"50%", width:900, height:900, animation:"spin-cw 30s linear infinite" }} viewBox="0 0 420 420" fill="none" overflow="visible">
